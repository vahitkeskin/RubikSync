...
val KoStrings = AppStrings(
    ...
    permissionRequiredTitle = "카메라 권한 필요",
    cameraPermissionDesc = "루빅스 큐브의 색상을 자동으로 감지하려면 카메라를 사용해야 합니다. 카메라로 큐브의 면을 촬영하면 몇 초 만에 해법을 볼 수 있습니다. 권한은 안전하게 보관됩니다.",
    permissionLater = "나중에",
    permissionGrant = "허용",
    cameraPermissionDenied = "카메라 권한이 거부되었습니다. 갤러리를 사용해 스캔할 수 있습니다.",
    cubeSkinTitle = "큐브 디자인",
    cubeSkinSubtitle = "3D 큐브의 스킨을 선택하세요",
    skinClassic = "클래식",
    skinShinyGold = "샤이니 골드",
    skinShinySilver = "샤이니 실버",
    skinNeon = "네온 글로우",
    skinPastel = "파스텔 드림",
    skinClassicDesc = "기본 설정 외관",
    skinShinyGoldDesc = "고급스러운 메탈릭 골드",
    skinShinySilverDesc = "미래지향적인 크롬 스타일",
    skinNeonDesc = "선명하게 빛나는 네อน 색조",
    skinPastelDesc = "부드럽고 깨끗한 톤",
    showPreview = "미리보기 표시",
