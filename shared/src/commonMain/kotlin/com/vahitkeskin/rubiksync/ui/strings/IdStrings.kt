...
val IdStrings = AppStrings(
    ...
    permissionRequiredTitle = "Izin Kamera Diperlukan",
    cameraPermissionDesc = "Kami perlu menggunakan kamera Anda untuk mendeteksi warna kubus Rubik secara otomatis. Dengan mengambil foto sisi-sisi kubus, Anda dapat melihat solusinya dalam hitungan detik. Izin Anda disimpan dengan aman.",
    permissionLater = "Nanti",
    permissionGrant = "Izinkan",
    cameraPermissionDenied = "Izin kamera ditolak. Anda dapat menggunakan galeri untuk memindai.",
    cubeSkinTitle = "Desain Kubus",
    cubeSkinSubtitle = "Pilih tampilan untuk kubus 3D Anda",
    skinClassic = "Klasik",
    skinShinyGold = "Emas Berkilau",
    skinShinySilver = "Perak Berkilau",
    skinNeon = "Cahaya Neon",
    skinPastel = "Mimpi Pastel",
    skinClassicDesc = "Tampilan default",
    skinShinyGoldDesc = "Emas metalik mewah",
    skinShinySilverDesc = "Tampilan krom futuristik",
    skinNeonDesc = "Rona bercahaya yang cerah",
    skinPastelDesc = "Nada lembut dan bersih",
