...
val NlStrings = AppStrings(
    ...
    permissionRequiredTitle = "Cameratoegang Vereist",
    cameraPermissionDesc = "We moeten je camera gebruiken om de kleuren van de Rubik's kubus automatisch te detecteren. Door foto's te maken van de vlakken van de kubus, zie je de oplossing in enkele seconden. Je toestemming wordt veilig opgeslagen.",
    permissionLater = "Later",
    permissionGrant = "Toestaan",
    cameraPermissionDenied = "Cameratoegang geweigerd. Je kunt de galerij gebruiken om te scannen.",
    cubeSkinTitle = "Kubusontwerp",
    cubeSkinSubtitle = "Kies een uiterlijk for je 3D-kubus",
    skinClassic = "Klassiek",
    skinShinyGold = "Glanzend Goud",
    skinShinySilver = "Glanzend Zilver",
    skinNeon = "Neon Gloed",
    skinPastel = "Pasteldroom",
    skinClassicDesc = "Standaard uiterlijk",
    skinShinyGoldDesc = "Luxueus goud metallic",
    skinShinySilverDesc = "Futuristische chroomlook",
    skinNeonDesc = "Levendige lichtgevende tinten",
    skinPastelDesc = "Zachte en schone tonen",
