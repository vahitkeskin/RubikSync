...
val ZhStrings = AppStrings(
    ...
    permissionRequiredTitle = "需要相机权限",
    cameraPermissionDesc = "我们需要使用您的相机来自动识别魔方的颜色。通过使用相机拍照魔方的各个面，您可以在几秒钟内看到解决方案。您的权限将被安全存储。",
    permissionLater = "稍后",
    permissionGrant = "授权",
    cameraPermissionDenied = "相机权限已被拒绝。您可以使用图库进行扫描。",
    cubeSkinTitle = "魔方外观",
    cubeSkinSubtitle = "为您的3D魔方选择外观",
    skinClassic = "经典",
    skinShinyGold = "亮丽金",
    skinShinySilver = "耀眼银",
    skinNeon = "霓虹光",
    skinPastel = "柔和粉",
    skinClassicDesc = "默认外观",
    skinShinyGoldDesc = "奢华金属金",
    skinShinySilverDesc = "未来感铬合金外观",
    skinNeonDesc = "鲜艳的发光色调",
    skinPastelDesc = "柔和纯净的色调",
    showPreview = "显示预览",
    closePreview = "关闭预览",
)
