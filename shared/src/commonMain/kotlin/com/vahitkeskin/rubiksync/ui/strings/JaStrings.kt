...
val JaStrings = AppStrings(
    ...
    permissionRequiredTitle = "カメラのアクセス権限が必要です",
    cameraPermissionDesc = "ルービックキューブの色を自動的に検出するためにカメラを使用する必要があります。カメラでキューブの面を撮影することで、数秒で解法を確認できます。許可情報は安全に保存されます。",
    permissionLater = "後で",
    permissionGrant = "許可する",
    cameraPermissionDenied = "カメラのアクセス権限が拒否されました。ギャラリーを使用してスキャンできます。",
    cubeSkinTitle = "キューブのデザイン",
    cubeSkinSubtitle = "3Dキューブの外観を選択します",
    skinClassic = "クラシック",
    skinShinyGold = "シャイニーゴールド",
    skinShinySilver = "シャイニーシルバー",
    skinNeon = "ネオンの輝き",
    skinPastel = "パステルドリーム",
    skinClassicDesc = "デフォルトの外観",
    skinShinyGoldDesc = "豪華なメタリックゴールド",
    skinShinySilverDesc = "近未来的で美しいクローム調",
    skinNeonDesc = "鮮やかに光るネオンカラー",
    skinPastelDesc = "柔らかく清潔感のあるトーン",
