...
val ItStrings = AppStrings(
    ...
    permissionRequiredTitle = "Autorizzazione Fotocamera Richiesta",
    cameraPermissionDesc = "Dobbiamo utilizzare la tua fotocamera per rilevare automaticamente i colori del cubo di Rubik. Scattando foto delle facce del cubo, potrai vedere la soluzione in pochi secondi. La tua autorizzazione è memorizzata in modo sicuro.",
    permissionLater = "Più tardi",
    permissionGrant = "Consenti",
    cameraPermissionDenied = "Autorizzazione fotocamera negata. Puoi usare la galleria per scansionare.",
    cubeSkinTitle = "Design del Cubo",
    cubeSkinSubtitle = "Scegli uno stile per il tuo cubo 3D",
    skinClassic = "Classico",
    skinShinyGold = "Oro Lucido",
    skinShinySilver = "Argento Lucido",
    skinNeon = "Bagliore Neon",
    skinPastel = "Sogno Pastel",
    skinClassicDesc = "Aspetto predefinito",
    skinShinyGoldDesc = "Lussuoso oro metallizzato",
    skinShinySilverDesc = "Look cromato futuristico",
    skinNeonDesc = "Tonalità vivaci e luminose",
    skinPastelDesc = "Toni morbidi e puliti",
